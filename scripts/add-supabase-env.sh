...
NEXT_PUBLIC_SUPABASE_ANON_KEY=请替换为您的anon_key
SUPABASE_SERVICE_ROLE_KEY=请替换为您的service_role_key
...
# 缓存配置
CACHE_TTL=3600000" >> .env.local

echo "✅ Supabase 环境变量已添加到 .env.local"
