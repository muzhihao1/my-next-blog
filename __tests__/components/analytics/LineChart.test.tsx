...
describe('LineChart', () => {
  ...
  beforeEach(() => {
    ...
    Object.defineProperty(HTMLCanvasElement.prototype, 'getBoundingClientRect', {
      value: () => ({ width: 600, height: 300, left: 0, top: 0, right: 600, bottom: 300 })
    })
  })
  ...
  it('renders with title', () => {
    ...
    expect(mockContext.fillText).toHaveBeenCalledWith('测试图表', expect.any(Number), expect.any(Number))
  })
  ...
  it('renders axis labels', () => {
    ...
    expect(mockContext.fillText).toHaveBeenCalledWith('月份', expect.any(Number), expect.any(Number))
    expect(mockContext.fillText).toHaveBeenCalledWith('访问量', expect.any(Number), expect.any(Number))
  })
