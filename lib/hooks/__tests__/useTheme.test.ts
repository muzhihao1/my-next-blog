...
describe('useTheme', () => {
  ...
  it('uses system preference when no saved theme', () => {
    localStorageMock.getItem.mockReturnValue(null)
    mockMediaQueryList.matches = true // prefers dark
  ...
  it('listens to system theme changes when no saved preference', () => {
    localStorageMock.getItem.mockReturnValue(null)
    let changeHandler: ((e: MediaQueryListEvent) => void) | null = null
    
    mockMediaQueryList.addEventListener.mockImplementation((event: string, handler: any) => {
      if (event === 'change') {
  ...
  it('ignores system theme changes when user has saved preference', () => {
    localStorageMock.getItem.mockReturnValue('light')
    let changeHandler: ((e: MediaQueryListEvent) => void) | null = null
    ...
    // Theme should remain light (user preference)
    expect(result.current.theme).toBe('light')
  })
