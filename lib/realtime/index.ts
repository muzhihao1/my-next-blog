...
export {
  ...
  getRealtimeComments,
  useRealtimeComments,
  type CommentRealtimeData,
  type CommentTypingData,
} from './features/comments'

export {
  RealtimePresence,
  getPresenceManager,
  disconnectPresenceManager,
  useOnlinePresence,
...
import { getPresenceManager } from './features/presence'
import { getNotificationManager } from './features/notifications'
import { RealtimeConfig } from './config'

/**
 * 初始化所有实时功能
 */
export async function initializeRealtime(config?: Partial<RealtimeConfig>) {
  // 初始化客户端
...
export function useRealtime(config?: Partial<RealtimeConfig>) {
