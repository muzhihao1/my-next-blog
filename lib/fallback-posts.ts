...
<li>写出引言的第一段</li>
<li>收集三个关键数据</li> </ul>
<p>记住：<em>开始永远比完美更重要。</em></p> ` }, { id: '2', title: '理解 React 18 的并发特性', slug: 'react-18-concurrent-features', excerpt: '深入探讨 React 18 带来的并发渲染机制，以及如何在项目中有效利用这些新特性。', date: '2024-11-20', readTime: '6 min read', category: 'Technology', author: { name: 'Zhihao Mu', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&q=80' }, tags: ['React', 'JavaScript', '前端'], published: true, createdTime: '2024-11-20T00:00:00.000Z', lastEditedTime: '2024-11-20T00:00:00.000Z', content: ` <p>React 18 引入了备受期待的并发特性，这是 React 发展历程中的一个重要里程碑。这些新特性不仅提升了应用的性能，更重要的是改善了用户体验。</p>
<h2>什么是并发渲染？</h2>
