...
import { runCommentTests } from './comments.test'
...
async function runAllTests() {
  ...
  const allResults = {
    ...
    comments: { total: 0, passed: 0, failed: 0 },
  }

  // 1. 认证系统测试
  console.log('📦 模块1：认证系统')
  console.log('==========================================')
  ...
  console.log('\n📦 模块2：评论系统')
  console.log('==========================================')
  allResults.comments = await runCommentTests()
  ...
  Object.entries(allResults).forEach(([module, results]) => {
    ...
    console.log(`${status} ${module.padEnd(10)} - 通过率: ${passRate}% (${results.passed}/${results.total})`)
  })
