...
export default function SubscribeForm({ 
      ...
      <div className={`bg-gray-50 dark:bg-gray-800 rounded-lg p-6 ${className}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <input
            ...
            className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
            required
          />
  ...
  return (
    <div className={`subscribe-section ${className}`}>
      <h3 className="text-2xl font-light mb-4 text-gray-900 dark:text-white">
        喜欢这篇文章？
      </h3>
      ...
      <form onSubmit={handleSubmit} className="max-w-md mx-auto space-y-4">
        <div className="flex gap-3">
          <input
            ...
            placeholder="您的名字（可选）"
            disabled={status === 'loading' || status === 'success'}
            className="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-pink-500 focus:ring-2 focus:ring-pink-200 dark:focus:ring-pink-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          />
          <input
            type="email"
            value={email}
