...
/**
 * 评论组件
 * @module components/features/Comments
 * @description 使用 Giscus（基于 GitHub Discussions）实现评论功能
 */
...
interface CommentsProps {
  ...
  /**
   * 当 mapping 为 'specific' 或 'number' 时使用
   */
  term?: string
  /**
   * 是否启用反应（表情回应）
 ...
 * Giscus 评论组件
 * @component
 * @param {CommentsProps} props - 组件属性
 * @returns {JSX.Element} 渲染的评论组件
 * @description 集成 Giscus 评论系统，基于 GitHub Discussions。
 * 支持主题切换、多语言、自定义映射方式等功能。
 * 需要配置 GitHub 仓库和 Giscus 相关环境变量。
 * @example
 * <Comments 
 *   repo="username/repo"
 *   repoId="R_xxx"
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 pt-12">
        ...
        <div className="prose dark:prose-invert max-w-none mb-6">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            评论功能基于 GitHub Discussions，需要 GitHub 账号才能评论。
            您的评论会同步显示在 <a 
        ...
        <div ref={ref} className="giscus-wrapper min-h-[200px]" />
      </div>
    </div>
  )
}