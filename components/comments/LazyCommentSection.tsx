/**
 * 懒加载评论组件
 * 使用Intersection Observer实现视口检测加载
 */
...
import { LoadingSpinner } from '@/components/a11y/AriaLabels'
...
interface LazyCommentSectionProps {
  ...
  threshold?: number // 触发加载的可见度阈值
  rootMargin?: string // 提前加载的边距
}

export function LazyCommentSection({
  contentId,
  contentType,
  threshold = 0.1,
  rootMargin = '100px'
      ...
      {shouldLoad ? (
        ...
        <div className="text-center py-12">
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg transition-colors"
            aria-label="加载评论"
          >
...
function CommentSectionSkeleton() {
  return (
    <div className="animate-pulse">
      ...
      {/* 表单骨架 */}
      <div className="mb-8">
        <div className="h-32 bg-gray-100 dark:bg-gray-800 rounded-lg mb-2" />
 ...
 * 在用户可能需要时提前加载
 */
export function preloadCommentSection() {
  // 预加载组件代码
