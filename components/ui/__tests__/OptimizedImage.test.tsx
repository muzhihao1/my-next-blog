...
describe('OptimizedImage', () => {
  ...
  it('shows error state when image fails to load', async () => {
    ...
    await waitFor(() => {
      const errorPlaceholder = container.querySelector('svg')
  ...
  it('renders with fill prop', () => {
    ...
    const image = screen.getByRole('img')
    // Fill images should have object-cover class
    expect(image).toHaveClass('object-cover')
    // Fill prop means no width/height attributes
  ...
  it('uses custom sizes prop when provided', () => {
    render(
      <OptimizedImage
        src="/test-image.jpg"
        alt="Test image"
