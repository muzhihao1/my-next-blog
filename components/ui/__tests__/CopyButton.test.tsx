...
describe('CopyButton', () => {
  ...
  it('handles multiple clicks correctly', async () => {
    ...
    // Second click while still showing "已复制"
    await act(async () => {
      button.click()
    })
  ...
  it('preserves custom children during copied state', async () => {
    render(
    ...
    const button = screen.getByRole('button')
    expect(button).toHaveTextContent('Click to copy')
    
    await act(async () => {
      button.click()
    })
    
    // Should show "已复制" instead of custom children
    expect(button).toHaveTextContent('已复制')
    expect(button).not.toHaveTextContent('Click to copy')
  })
})