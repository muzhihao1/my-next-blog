...
return ( <div className={cn("relative overflow-hidden", fill && "w-full h-full", className)}> {isLoading && ( <div className="absolute inset-0 bg-gray-100 animate-pulse" /> )}
<Image src={src}
alt={alt}
...
priority={priority}
className={cn( "transition-opacity duration-300", isLoading ? "opacity-0" : "opacity-100", fill && "object-cover" )}
onLoad={handleLoad}
onError={handleError}
placeholder="blur" blurDataURL={placeholderSrc}
/> </div> ) }