...
import { loading } from '@/lib/animation/constants'
...
export function LoadingSpinner({
  ...
  if (variant === 'pulse') {
    return (
      <motion.div
        className={cn(sizes[size], "rounded-full bg-current", className)}
      ...
      {isLoading && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-lg p-6 flex flex-col items-center space-y-4"
          >
