...
import { fadeInVariants, fadeInUpVariants, scaleInVariants, slideInVariants } from '@/lib/animation/variants'
import { useScrollAnimation, useReducedMotionPreference } from '@/lib/animation/hooks'

interface AnimatedContainerProps extends Omit<HTMLMotionProps<"div">, 'children'> {
  children: ReactNode
  animation?: 'fadeIn' | 'fadeInUp' | 'scaleIn' | 'slideLeft' | 'slideRight' | 'slideUp' | 'slideDown'
  delay?: number
  duration?: number
  triggerOnce?: boolean
  threshold?: number
