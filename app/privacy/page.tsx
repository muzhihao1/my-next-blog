    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>我们收集的信息类型包括：</p>
          <ul>
            <li><strong>基本信息</strong>：当您订阅博客或发表评论时，我们可能收集您的电子邮件地址和用户名。</li>
            <li><strong>使用数据</strong>：我们收集有关您如何与网站互动的信息，包括访问的页面、点击的链接和阅读时长。</li>
            <li><strong>技术信息</strong>：包括您的IP地址、浏览器类型、操作系统和设备信息。</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul>
            ...
            <li><strong>Giscus</strong>：用于评论系统</li>
            <li><strong>Notion API</strong>：用于内容管理</li>
          </ul>
          <p>
        ...
        <section className="mb-8">
          ...
          <ul>
            <li>电子邮件：[您的邮箱地址]</li>
            <li>GitHub：<Link href="https://github.com/[您的GitHub用户名]" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">[您的GitHub用户名]</Link></li>
          </ul>
        </section>
