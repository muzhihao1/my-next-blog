...
export const metadata: Metadata = {
  title: '关于我',
  description: '了解更多关于我的背景、技能和经历。全栈开发者，技术作家，终身学习者。',
  openGraph: {
    title: '关于我 - Zhihao Mu',
    description: '了解更多关于我的背景、技能和经历。全栈开发者，技术作家，终身学习者。',
    type: 'profile',
...
export default function About() {
  ...
  const personStructuredData = generatePersonStructuredData({
    ...
    jobTitle: '全栈开发者',
    description: '热爱技术，享受创造。专注于构建优雅的解决方案，分享知识与经验。',
  ...
  return (
    <div className="container max-w-4xl py-12">
      <SEO structuredData={personStructuredData} />
      {/* Hero Section */}
      <section className="mb-16">
        <div className="flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-4xl font-bold mb-4">你好，我是 Zhihao Mu</h1>
      ...
      <section className="mb-16">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          <p className="text-lg leading-relaxed mb-4">
            ...
            对着黑白的终端窗口，敲下第一个 &ldquo;Hello World&rdquo;，感受到了创造的魅力。
          </p>
          <p className="text-lg leading-relaxed mb-4">
      ...
      {/* Timeline */}
      <section className="mb-16">
        <h2 className="text-3xl font-bold mb-6">职业经历</h2>
        <Timeline />
      </section>
