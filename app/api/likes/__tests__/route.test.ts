...
describe('/api/likes', () => {
  ...
  describe('GET /api/likes', () => {
    it('returns like count and status', async () => {
      ...
      const mockSingle = jest.fn().mockResolvedValue({ data: { id: 'like-1' }, error: null })
  ...
  describe('POST /api/likes', () => {
    ...
    it('adds a like successfully', async () => {
      ...
      const mockSingle = jest.fn()
        ...
        .mockResolvedValueOnce({ data: { id: 'like-1' }, error: null }) // New like created
    ...
    it('returns error if already liked', async () => {
      mockCreateClient.mockResolvedValue({
        auth: {
          getUser: jest.fn().mockResolvedValue({
            data: { user: mockUser },
