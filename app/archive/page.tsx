              ...
              {postsByYear[year].map(post => (
                <article key={post.id} className="group">
                  <Link
                    ...
                    className="flex items-start justify-between hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-lg p-4 -mx-4 transition-colors"
                  >
                    <div>
                    ...
                    <time className="flex-shrink-0 ml-4 text-sm text-gray-500 dark:text-gray-400">
