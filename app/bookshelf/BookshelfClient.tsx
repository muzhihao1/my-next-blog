/**
 * 书架客户端组件
 * @module app/bookshelf/BookshelfClient
 */
 ...
 * 书架客户端组件
 * @component
 * @param {BookshelfClientProps} props - 组件属性
 * @returns {JSX.Element} 渲染的书架页面
 * @description 提供书籍的展示、筛选、排序功能。支持网格和列表两种视图模式，
 * 可按阅读状态、分类筛选，支持按日期、评分、书名排序。
 * 包含阅读统计信息展示和懒加载优化。
 * @example
 * <BookshelfClient books={booksData} />
 */
    ...
    <PageContainer size="xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 text-center border border-gray-200 dark:border-gray-700">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">已读</div>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 text-center border border-gray-200 dark:border-gray-700">
            <div className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{stats.reading}</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">在读</div>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 text-center border border-gray-200 dark:border-gray-700">
            <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{stats.wantToRead}</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">想读</div>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 text-center border border-gray-200 dark:border-gray-700">
        ...
        <div className={view === 'grid' 
          ...
          {filteredAndSortedBooks.map((book) => (
            <LazyLoad
              ...
              placeholder={
                <div className={view === 'grid' 
                  ? 'aspect-[3/4] bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse'
                  : 'h-28 bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse'
                } />
              }
            >
