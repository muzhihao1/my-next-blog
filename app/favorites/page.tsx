...
import { useFavorites, FavoriteType, formatFavoriteDate, getFavoriteStats } from '@/lib/hooks/useFavorites'
 ...
 * @param {import('@/lib/hooks/useFavorites').FavoriteItem} props.item - 收藏项
 * @param {() => void} props.onRemove - 移除回调
 * @returns {JSX.Element} 渲染的收藏项卡片
 */
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 text-center">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">书籍</div>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">
              {stats.byType[FavoriteType.TOOL] || 0}
            </div>
            <div className="text-sm text-gray-600 dark:text-gray-400">工具</div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          ...
          <div className="flex-1">
            <input
              ...
              className="w-full px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 dark:focus:border-blue-400"
            />
          </div>
          ...
          <select
            ...
            className="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 dark:focus:border-blue-400"
          >
