      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white transform hover:scale-105 transition-transform">
            ...
            <div className="text-blue-100">篇文章</div>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white transform hover:scale-105 transition-transform">
            ...
            <div className="text-green-100">字创作</div>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-white transform hover:scale-105 transition-transform">
            ...
            <div className="text-purple-100">个项目</div>
          </div>
          ...
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 text-white transform hover:scale-105 transition-transform">
            ...
            <div className="text-orange-100">本书籍</div>
          </div>
        </div>
                    ...
                    <div
                      className={`w-full max-w-[40px] transition-all duration-300 rounded-t-lg ${
                        isSelected
                          ...
                          : 'bg-blue-400 dark:bg-blue-600 hover:bg-blue-500 dark:hover:bg-blue-500'
                      }`}
            ...
            {selectedMonth && (
              <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                <p className="text-center text-gray-700 dark:text-gray-300">
                  {monthNames[parseInt(selectedMonth) - 1]}发布了 
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              {yearStats.posts.tags.map((tag) => {
                ...
                return (
                  <span
                    key={tag.name}
                    className="inline-block px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900 transition-colors cursor-pointer"
                  ...
                  return (
                    <div key={tech.name}>
                      <div className="flex justify-between mb-2">
                        ...
                        <span className="text-gray-600 dark:text-gray-400">{tech.count} 个项目</span>
                      </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-lg">
              ...
              <div className="text-gray-600 dark:text-gray-400">最高产月份</div>
            </div>
            
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-lg">
              <div className="text-3xl mb-4">🔥</div>
              <div className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                {yearStats.posts.writingStreak.longest} 天
              </div>
              <div className="text-gray-600 dark:text-gray-400">最长连续创作</div>
            </div>
            
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-lg">
              <div className="text-3xl mb-4">📝</div>
              <div className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                {formatNumber(yearStats.posts.averageWords)} 字
              </div>
              <div className="text-gray-600 dark:text-gray-400">平均每篇字数</div>
            </div>
          </div>
        </section>
        ...
        <section className="text-center">
          <div className="bg-gradient-to-r from-gray-900 to-gray-700 dark:from-gray-800 dark:to-gray-600 rounded-2xl p-12 text-white">
            ...
            <div className="text-xl space-y-2">
              ...
              <p>最爱写 <span className="font-bold text-yellow-400">{yearStats.highlights.favoriteCategory}</span> 相关内容</p>
            </div>
            <div className="mt-8">
              <Link
                href="/blog"
