                  ...
                  return (
                    <div key={tech.name}>
                      <div className="flex justify-between mb-2">
                        ...
                        <span className="text-gray-600">{tech.count} 个项目</span>
                      </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 text-center shadow-lg">
              ...
              <div className="text-gray-600">最高产月份</div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 text-center shadow-lg">
              ...
              <div className="text-gray-600">最长连续创作</div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 text-center shadow-lg">
              ...
              <div className="text-gray-600">平均每篇字数</div>
            </div>
          </div>
        </section>
