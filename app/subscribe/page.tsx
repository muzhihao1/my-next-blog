/**
 * 订阅页面
 * @module app/subscribe/page
 * @description 展示所有可用的订阅方式
 */
...
export default function SubscribePage() {
  ...
  const feedReaders = [
    ...
    { name: 'NetNewsWire', url: 'https://netnewswire.com', description: 'Mac 和 iOS 原生应用' },
    { name: 'Reeder', url: 'https://reederapp.com', description: '优雅的阅读体验' }
  ]
    ...
    <div className="py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8">
